# Generated by Django 2.2.4 on 2020-03-09 06:58
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='QuestionInQueue',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('index', models.IntegerField()),
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bingo.Question')),
                ('queue', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bingo.Queue')),
            ],
        ),
        migrations.CreateModel(
            name='Cell',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bingo.QuestionInQueue'),
        ),
        migrations.AddField(
            model_name='board',
            name='player',
